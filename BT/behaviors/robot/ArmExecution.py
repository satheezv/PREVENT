...
class ExecuteArmTaskBehavior(py_trees.behaviour.Behaviour):
    """
    ...
    def __init__(self, name, node_id, task_type, task_name, program_name):
        ...
        """
        super(ExecuteArmTaskBehavior, self).__init__(name)
    ...
    def update(self):
        ...
        try:
            ...
            if not self.executed:
                ...
                self.kuka_publisher.publish_task(node_id=self.node_id, task_type=self.task_type, task_name=self.task_name, seq_id=self._seq_id, program_name=self.program_name, fine_localization=True)  # ✅ Ensure stop message is published
