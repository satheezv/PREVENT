...
from kmriiwa_chemist_msgs.msg import RobotCommand, LBRCommand, KMPCommand, RobotStatus, TaskStatus
import rospy
import datetime
...
def publish_ros_msg():
    ...
    kuka_cmd.task_type = 1
    kuka_cmd.task_name = "unlock"
    ...
    arm_command.program_name = "unlock"
