...
class KukaStopPublisher:
    ...
    def __init__(self, node_id, task_type, task_name):
        ...
        if not rospy.core.is_initialized():
            rospy.init_node("kuka_stop_pub_node", anonymous=True, disable_signals=True)  # ✅ Allow manual signal handling
    ...
    def publish_task(self):
        ...
        kuka_cmd.seq = self.get_seq_id()  # Unique ID
        ...
        base_command.fine_localization = False

        arm_command.program_name = "test__"  # Custom stop command
        ...
        for i in range(5):
            ...
            rospy.loginfo(f"Published Nav command: {kuka_cmd.task_name}")
            rospy.sleep(1)
